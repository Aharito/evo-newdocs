...
title: Развертывание
slug: razvertyvanie
lastmod: 2023-11-17T05:36:48.477Z
---
...
Не забудьте создать и [корректно заполнить](docs/v3/003_Конфигурация.md) файлы `core\custom\config\cms\settings.php` и `core\custom\.env`.
