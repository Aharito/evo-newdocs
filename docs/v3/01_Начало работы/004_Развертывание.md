...
permalink: razvertyvanie
title: Развертывание
slug: razvertyvanie
lastmod: 2023-11-17T05:18:30.838Z
---

# Разработка и развертывание Evolution CMS

1. [Введение](#section1)
1. [Требования к хостингу](#section2)
1. [ssh](#section3)
1. [Порядок действий](#section4)
   1. [Создайте ключи](#section4-1)
   1. [Добавьте публичный ключ](#section4-2)
   1. [Проверьте репозиторий](#section4-3)
   1. [Пример файла .gitignore](#section4-4)
   1. [Проверьте работоспособность ключа](#section4-5)
   1. [Клонируйте репозиторий](#section4-6)
   1. [Заберите изменения](#section4-7)
   1. [Установите нужные пакеты](#section4-8)
   1. [Создайте файлы конфигурации](#section4-9)
   1. [База данных](#section4-10)
   1. [Отладка](#section4-11)
...
Не забудьте создать и [корректно заполнить]({% link docs/v3/003_Конфигурация.md %}) файлы `core\custom\config\cms\settings.php` и `core\custom\.env`.
