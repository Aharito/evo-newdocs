...
lastmod: 2023-11-17T05:47:03.621Z
...
## С помощью composer <a name="section1"></a>
...
## С помощью файла быстрой установки  <a name="section2"></a>
...
## Закачать дистрибутив вручную  <a name="section3"></a>
...
## Автоматическая установка через sh  <a name="section4"></a>
